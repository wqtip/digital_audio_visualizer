...
//    sqrt sqrt0(.din(fft_square_magnitudes[0]),.dout(fft_magnitudes[0]));
//    sqrt sqrt1(.din(fft_square_magnitudes[1]),.dout(fft_magnitudes[1]));
//    sqrt sqrt2(.din(fft_square_magnitudes[2]),.dout(fft_magnitudes[2]));
//    sqrt sqrt3(.din(fft_square_magnitudes[3]),.dout(fft_magnitudes[3]));
//    sqrt sqrt4(.din(fft_square_magnitudes[4]),.dout(fft_magnitudes[4]));
//    sqrt sqrt5(.din(fft_square_magnitudes[5]),.dout(fft_magnitudes[5]));
//    sqrt sqrt6(.din(fft_square_magnitudes[6]),.dout(fft_magnitudes[6]));
//    sqrt sqrt7(.din(fft_square_magnitudes[7]),.dout(fft_magnitudes[7]));
//    sqrt sqrt8(.din(fft_square_magnitudes[8]),.dout(fft_magnitudes[8]));
//    sqrt sqrt9(.din(fft_square_magnitudes[9]),.dout(fft_magnitudes[9]));
//    sqrt sqrt10(.din(fft_square_magnitudes[10]),.dout(fft_magnitudes[10]));
//    sqrt sqrt11(.din(fft_square_magnitudes[11]),.dout(fft_magnitudes[11]));
//    sqrt sqrt12(.din(fft_square_magnitudes[12]),.dout(fft_magnitudes[12]));
//    sqrt sqrt13(.din(fft_square_magnitudes[13]),.dout(fft_magnitudes[13]));
//    sqrt sqrt14(.din(fft_square_magnitudes[14]),.dout(fft_magnitudes[14]));
//    sqrt sqrt15(.din(fft_square_magnitudes[15]),.dout(fft_magnitudes[15]));
